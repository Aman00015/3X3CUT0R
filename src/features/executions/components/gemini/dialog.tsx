              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  {isLoadingCredentials && (
                    <FormDescription>
                      Loading Gemini credentials...
                    </FormDescription>
                  )}
                  {isCredentialsError && (
                    <FormDescription>
                      Failed to load Gemini credentials: {credentialsError.message}
                    </FormDescription>
                  )}
                  {!isLoadingCredentials && !isCredentialsError && !hasCredentials && (
                    <FormDescription>
                      No Gemini credentials found. Create one in{" "}
                      <Link href="/credentials/new" className="underline">
                        Credentials
                      </Link>
                      .
                    </FormDescription>
