    ...
    >
      <div className="flex items-center justify-between h-[60px] px-6 md:px-[48px] max-w-[1400px] mx-auto">
        ...
        <a href="#" className="flex items-center gap-[10px] shrink-0 group">
          <span className="w-[10px] h-[10px] bg-[#FF6B35] group-hover:scale-110 transition-transform" />
          ...
          {links.map(({ label, section }) => {
            ...
            return (
              <button
                ...
                style={{ color: isActive ? "#FF6B35" : "#555" }}
                onMouseEnter={(e) => {
                  if (!isActive) (e.currentTarget as HTMLButtonElement).style.color = "#F5F5F0";
                }}
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLButtonElement).style.color = isActive ? "#FF6B35" : "#555";
                }}
              >
                {label}
                <span
                  className="absolute left-0 -bottom-[3px] h-[1.5px] bg-[#FF6B35] transition-all duration-300"
            ...
            return (
              ...
              >
                <span
                  ...
                  style={{ background: isActive ? "#FF6B35" : "#2D2D2D" }}
                />
                {label}
              </button>
            );
