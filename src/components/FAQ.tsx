...
const faqs = [
  {
    question: "IS 3X3CUT0R REALLY FREE TO START?",
    answer:
  ...
  { question: "DO I NEED TO KNOW HOW TO CODE?", answer: "NO. 3X3CUT0R IS DESIGNED FOR BOTH DESIGNERS AND DEVELOPERS. OUR VISUAL EDITOR REQUIRES ZERO CODING KNOWLEDGE TO BUILD LOGIC-PERFECT UIS." },
  ...
  { question: "CAN I MIGRATE FROM FIGMA?", answer: "YES. USE OUR FIGMA IMPORT PLUGIN TO BRING YOUR EXISTING DESIGNS INTO 3X3CUT0R. COMPONENTS, STYLES, AND LAYOUTS ARE AUTOMATICALLY CONVERTED." },
...
export default function FAQ() {
  ...
  return (
            ...
            <div key={i} className="flex flex-col w-full border-t border-t-[#1D1D1D]">
              ...
              >
                ...
                <div
                  ...
                  style={{ backgroundColor: isOpen ? "#FF6B35" : "#1A1A1A", border: isOpen ? "none" : "1px solid #3D3D3D" }}
                >
                  <span
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-[16px] pt-10 md:pt-[48px]">
        ...
        <span className="font-ibm-mono text-[13px] font-bold text-[#FF6B35] tracking-[1px] cursor-pointer hover:underline">
          TALK TO A HUMAN &gt;
        </span>
      </div>
    </section>
